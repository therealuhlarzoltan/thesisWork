package hu.uni_obuda.thesis.railways.cloud.configserver;
...
public class ConfigServerApplication {
    ...
    public static void main(String[] args) {
        ...
        LOG.info("Loading configurations from folder: " + repoLocation);
        LOG.info("Auth credentials: {}/{}", userName, password);
