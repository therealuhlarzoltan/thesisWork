package hu.uni_obuda.thesis.railways.data.geocodingservice.config;
...
import hu.uni_obuda.thesis.railways.data.geocodingservice.workers.MessageProcessorImpl;
import hu.uni_obuda.thesis.railways.data.geocodingservice.workers.ResponseMessageSender;
...
public class MessageProcessorConfig {
    ...
    public Consumer<Message<Event<?, ?>>> messageProcessor() {
        return new MessageProcessorImpl(objectMapper, geocodingController, responseSender, messageProcessingScheduler());
    }
}
