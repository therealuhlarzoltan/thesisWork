...
import hu.uni_obuda.thesis.railways.data.delaydatacollector.worker.messaging.processor.CoordinateProcessorImpl;
import hu.uni_obuda.thesis.railways.data.delaydatacollector.worker.messaging.processor.DataRequestProcessorImpl;
import hu.uni_obuda.thesis.railways.data.delaydatacollector.worker.messaging.processor.DelayInfoProcessorImpl;
import hu.uni_obuda.thesis.railways.data.delaydatacollector.worker.messaging.processor.WeatherInfoProcessorImpl;
