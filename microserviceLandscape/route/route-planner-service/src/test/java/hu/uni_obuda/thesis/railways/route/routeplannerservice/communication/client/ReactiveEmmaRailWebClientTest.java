...
class ReactiveEmmaRailWebClientTest {
    ...
    private ReactiveEmmaRailWebClient testedObject;

    @BeforeEach
    void setUp() {
        testedObject = new ReactiveEmmaRailWebClient(webClient);
    ...
    void makeRouteRequest_success_returnsFluxOfTrainRouteResponse() {
        String from = "BP";
        double fromLatitude = 47.0;
        double fromLongitude = 19.0;
        String to = "DEB";
        double toLatitude = 47.5;
        double toLongitude = 21.6;
        ...
        Flux<TrainRouteResponse> result = testedObject.makeRouteRequest(
                from, fromLatitude, fromLongitude, to, toLatitude, toLongitude, date
        );
        ...
        assertTrue(uri.contains("fromLatitude=47.0"));
        assertTrue(uri.contains("fromLongitude=19.0"));
        assertTrue(uri.contains("to=DEB"));
        assertTrue(uri.contains("toLatitude=47.5"));
        assertTrue(uri.contains("toLongitude=21.6"));
